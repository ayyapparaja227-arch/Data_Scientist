...
```bash
git clone https://github.com/ayyapparaja227-arch/Lasso_Linear.git
cd Lasso_Linear
```
...
<table>
  ...
  <tr>
    ...
    <td><a href="https://github.com/ayyapparaja227-arch">@ayyapparaja227-arch</a></td>
  </tr>
</table>
...
<p align="center">
  Made with ❤️ using <strong>Streamlit</strong> &nbsp;|&nbsp; © 2026 Ayyapparaja
</p>