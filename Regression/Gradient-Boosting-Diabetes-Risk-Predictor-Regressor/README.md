...
```bash
git clone https://github.com/ayyapparaja227-arch/Diabetes-Gradient-Boosting.git
...
2. **Deploy on Streamlit Cloud**:
   ...
   - Sign in with GitHub
   - Click "New app"
   - Select repository: `ayyapparaja227-arch/Diabetes-Gradient-Boosting`
   - Main file: `app.py`
   - Click "Deploy"
